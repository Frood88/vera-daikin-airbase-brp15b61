...
local GET_BASIC_INFO_URL = "/skyfi/common/basic_info"
local GET_CONTROL_URL = "/skyfi/aircon/get_control_info"
local GET_MODEL_URL = "/skyfi/aircon/get_model_info"
local GET_SENSOR_URL = "/skyfi/aircon/get_sensor_info"
local GET_TARGET_URL = "/skyfi/aircon/get_target"
local GET_PROGRAM_URL = "/skyfi/aircon/get_program"

local SET_CONTROL_URL = "/skyfi/aircon/set_control_info"
local SET_TARGET_URL = "/skyfi/aircon/set_target"
local SET_PROGRAM_URL = "/skyfi/aircon/set_program"
...
function setModeTarget(lul_device, NewModeTarget)
    ...
    elseif(NewModeTarget == "CoolOn") then
      ...
      daikin_device.attributes["pow"].value = "1"
      daikin_device.attributes["mode"].value = newMode
	elseif(NewModeTarget == "FanOn") then
	  newMode = "0"
      daikin_device.attributes["pow"].value = "0"
      daikin_device.attributes["mode"].value = newMode
	elseif(NewModeTarget == "DryOn") then
	  newMode = "6"
      daikin_device.attributes["pow"].value = "0"
      daikin_device.attributes["mode"].value = newMode
    else
